...
public class Boat {
	...
	static void SampleItinerary() {
		...
		// System.out.println("\n ***Everyone piles on the boat and goes to
		// Molokai***");
		/*
		 * bg.AdultRowToMolokai(); bg.ChildRideToMolokai();
		 * bg.AdultRideToMolokai(); bg.ChildRideToMolokai();
		 */
	 ...
	 * 4)如果孩子线程和船都在O岛，但船上已经满载，则放弃船。 5)如果孩子线程和船都在M岛，则乘船驶回O岛唤醒O岛上的孩子大人线程进行船的资源争夺。
	 *
	 */
	...
	/**
	 * 对于大人线程： 大人的工作非常简单，只要自己从O岛到达M岛即可。首先大人进程会试图得到船的锁，在得到锁之后进行一系列的检查:

...
public class Boat {
	...
	static int passengerNum; // 船上乘客的数量
	static int childOnO; // 在O岛的孩子数目
	static int adultOnO; // 在O岛的大人数目
	static int childOnM; // 在M岛的孩子数目
	static int location; // 船的位置，在M岛或O岛，0是在O岛
	static Lock boatlock; // 控制对船使用的锁
	static Condition OA, OC, MA, MC; // 在O岛，M岛上睡眠的大人或小孩的条件变量
	static boolean overed; //问题是否已经解决

...
public class Communicator {
	 ...
	 */
	/**
	 * 先获得锁，然后进行判断，如果没有听者等待，就要把说者的话e放入队列然后睡眠。 如果有听者等待，就要唤醒一个听者，然后传递消息，最后释放锁。
	 * 
	 * @param word
	 */
	...
	Condition2 litener; // 听者条件变量
	private static int num_speaker = 0;
	private static int num_litener = 0;
	private Queue<Integer> queue = new LinkedList<Integer>(); // 说话者话语数量
}
